...
linreg$methods(initialize = function(formula, data){
  "Creates a linear model based on formula and data"
...
#Modifying Print
linreg$methods(show = function(){print(coefficients)})
...
linreg$methods(resid = function(){"Prints the residuals"; return(residuals)})
linreg$methods(pred = function(){"Prints the predicted values"; return(fitted_values)})
linreg$methods(coef = function(){"Prints the coefficients"; return(coefficients)})
#Summary
